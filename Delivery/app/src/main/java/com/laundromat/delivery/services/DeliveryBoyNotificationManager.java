...
public class DeliveryBoyNotificationManager {

    private static final int NOTIFICATION_REQUEST = 1;
    private static final String CHANNEL_FCM = "fcm_notification";
    private static DeliveryBoyNotificationManager instance;
    private Context context;

    private DeliveryBoyNotificationManager(Context context) {

        this.context = context;
    }

    public static DeliveryBoyNotificationManager getInstance(Context context) {
        if (instance == null) {

            instance = new DeliveryBoyNotificationManager(context);
        }
