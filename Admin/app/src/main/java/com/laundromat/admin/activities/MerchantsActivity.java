...
public class MerchantsActivity extends AppCompatActivity
    ...
    private void initRecyclerView() {
        ...
        Collections.sort(Session.user.getMerchants(), new Comparator<Merchant>() {
        ...
        merchants = Session.user.getMerchants();
        ...
        FirebaseFunctions
                ...
                .addOnSuccessListener(httpsCallableResult -> {
                    ...
                    Session.user.setMerchants(ParseUtils
                            .parseMerchants(httpsCallableResult.getData()));
                ...
                .addOnFailureListener(e -> {
                    ...
                    Toast.makeText(MerchantsActivity.this, e.getMessage(),
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.option_new_drivers:
                startActivity(new Intent(MerchantsActivity.this, NewDriversActivity.class));
                finish();
                break;
            ...
            case R.id.option_drivers:
                startActivity(new Intent(MerchantsActivity.this, DriversActivity.class));
                finish();
                break;

            case R.id.option_customers:
                startActivity(new Intent(MerchantsActivity.this, CustomersActivity.class));
                finish();
                break;

            case R.id.option_orders:
                startActivity(new Intent(MerchantsActivity.this, OrdersActivity.class));
                finish();
                break;

            case R.id.option_trips:
                startActivity(new Intent(MerchantsActivity.this, TripsActivity.class));
                finish();
                break;

            case R.id.option_services:
                startActivity(new Intent(MerchantsActivity.this, ServiceTypesActivity.class));
                finish();
                break;

            case R.id.option_config:
                startActivity(new Intent(MerchantsActivity.this, SettingsActivity.class));
                finish();
                break;
            ...
            case R.id.option_logout:
                ...
                alert.setPositiveButton("Yes", (dialog, whichButton) -> {
                    ...
                    dialog.dismiss();
                    Session.destroy(MerchantsActivity.this);

                    startActivity(new Intent(MerchantsActivity.this, LoginActivity.class));
                    finish();
                });
    ...
    public void onMerchantClick(int index, Merchant merchant) {
        ...
        intent.putExtra("transactions", GsonUtils.transactionsToGson(merchant.getTransactions()));
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_CODE_MERCHANT) {
