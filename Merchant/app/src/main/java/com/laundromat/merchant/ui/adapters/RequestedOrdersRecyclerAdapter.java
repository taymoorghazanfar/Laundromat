...
public class RequestedOrdersRecyclerAdapter
        extends RecyclerView.Adapter<RequestedOrdersRecyclerAdapter.ViewHolder> implements Filterable {

    private List<Order> orders;
    private List<Order> ordersFull;
    private IRequestedOrderClickListener requestedOrderClickListener;
    ...
    public RequestedOrdersRecyclerAdapter(List<Order> orders) {
    ...
    public void setRequestedOrderClickListener(IRequestedOrderClickListener requestedOrderClickListener) {
        this.requestedOrderClickListener = requestedOrderClickListener;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull RequestedOrdersRecyclerAdapter.ViewHolder holder, int position) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(view -> {
                ...
                if (requestedOrderClickListener != null
                        && position != RecyclerView.NO_POSITION) {

                    Order order = orders.get(position);

                    requestedOrderClickListener.onRequestedOrderClick(order);
                }
            });
        }
    }
