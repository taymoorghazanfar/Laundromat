...
public class HomeBasedLaundriesRecyclerAdapter
        extends RecyclerView.Adapter<HomeBasedLaundriesRecyclerAdapter.ViewHolder> implements Filterable {

    private List<LaundryRecyclerItem> laundries;
    private List<LaundryRecyclerItem> laundriesFull;
    private IHomeBasedLaundryClickListener laundryClickListener;
    private IHomeBasedLaundryFilterListener homeBasedLaundryFilterListener;
    ...
    private Filter itemFilter = new Filter() {
        ...
        protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
            ...
            if (((List) filterResults.values).isEmpty()) {
                ...
                if (homeBasedLaundryFilterListener != null) {

                    homeBasedLaundryFilterListener.onHomeBasedLaundriesFiltered(true);
                }
            } else {

                if (homeBasedLaundryFilterListener != null) {

                    homeBasedLaundryFilterListener.onHomeBasedLaundriesFiltered(false);
                }
            }
    ...
    public HomeBasedLaundriesRecyclerAdapter(List<LaundryRecyclerItem> laundries) {
        this.laundries = laundries;
        this.laundriesFull = new ArrayList<>(laundries);
    }

    public void setLaundryClickListener(IHomeBasedLaundryClickListener laundryClickListener) {
        this.laundryClickListener = laundryClickListener;
    }

    public void setHomeBasedLaundryFilterListener(IHomeBasedLaundryFilterListener homeBasedLaundryFilterListener) {
        this.homeBasedLaundryFilterListener = homeBasedLaundryFilterListener;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull HomeBasedLaundriesRecyclerAdapter.ViewHolder holder, int position) {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(view -> {
                ...
                if (laundryClickListener != null
                    ...
                    laundryClickListener.onHomeBasedLaundryClick(laundry.getLaundry());
                }
            });
        }
    }
