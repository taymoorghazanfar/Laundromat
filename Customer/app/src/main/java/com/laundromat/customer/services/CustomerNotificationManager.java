...
public class CustomerNotificationManager {

    private static final int NOTIFICATION_REQUEST = 1;
    private static final String CHANNEL_FCM = "fcm_notification";
    private static CustomerNotificationManager instance;
    private Context context;

    private CustomerNotificationManager(Context context) {

        this.context = context;
    }

    public static CustomerNotificationManager getInstance(Context context) {
        if (instance == null) {

            instance = new CustomerNotificationManager(context);
        }
    ...
    public void showNotification(Context context, String title, String message, Intent intent) {
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(context,
                NOTIFICATION_REQUEST, intent, PendingIntent.FLAG_ONE_SHOT);
